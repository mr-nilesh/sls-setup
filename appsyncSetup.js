...
module.exports = (mtDirName, lambdaFunctionsDir, applyVpcToLambdas) => {
  console.log('Setting up appsync mapping templates and serverless yml files.');
  mtDirName = mtDirName;
  lambdaFunctionsDir = lambdaFunctionsDir;
  applyVpcToLambdas = applyVpcToLambdas;
